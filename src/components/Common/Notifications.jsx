...
const Notifications = ({ onNavigate }) => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case "correction":
        return <WrenchScrewdriverIcon className="h-6 w-6 text-orange-500" />;
      case "system":
        return <Cog6ToothIcon className="h-6 w-6 text-gray-500" />;
      default:
        return <MegaphoneIcon className="h-6 w-6 text-gray-400" />;
    }
  };
  ...
  return (
    <div className="relative" ref={notificationRef}>
      ...
      >
        {unreadCount > 0 ? (
          <BellIconSolid className="h-6 w-6 text-white" />
        ) : (
